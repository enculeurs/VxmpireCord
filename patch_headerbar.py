...
with open(r"C:\Users\zzafi\Documents\GitHub\vxmpire\src\api\HeaderBar.tsx", "r", encoding="utf-8") as f:
    content = f.read()
...
function CompactHeaderBarToggle() {
    ...
    return (
        <HeaderBarButton
            ...
            tooltip="Compact Mode — Click to expand Vxmpire buttons"
...
with open(r"C:\Users\zzafi\Documents\GitHub\vxmpire\src\api\HeaderBar.tsx", "w", encoding="utf-8") as f:
    f.write(content)
