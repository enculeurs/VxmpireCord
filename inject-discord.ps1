# ==============================================================================
#  Vxmpire — Script d'injection Post-Installation
#  Utilisé par l'installateur Inno Setup pour injecter Vxmpire dans Discord.
# ==============================================================================
...
# On pointe vers le patcher.js dans le dossier d'installation de Vxmpire
$VxmpirePatcher = Join-Path $AppDir "dist\desktop\patcher.js"
$VxmpirePatcher = $VxmpirePatcher.Replace("\", "\\")
...
// Injection Vxmpire
try {
    require(\"$VxmpirePatcher\");
} catch (e) {
    console.error(\"Vxmpire injection failed:\", e);
