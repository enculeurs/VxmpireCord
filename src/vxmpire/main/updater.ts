...
// Vxmpire native defaults — no external prefs file, always on
const VXMPIRE_PREFS = { defaultPlugins: true, autoUpdate: true } as const;

export const installerPrefs = VXMPIRE_PREFS;

handle(IpcEvents.GET_INSTALLER_PREFS, () => VXMPIRE_PREFS);
