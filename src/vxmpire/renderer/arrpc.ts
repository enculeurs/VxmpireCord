...
import { Logger } from "@Vxmpire/types/utils";
import { findLazy, onceReady } from "@Vxmpire/types/webpack";
import {
    ...
    InviteActions,
    StreamerModeStore
} from "@Vxmpire/types/webpack/common";
import { IpcCommands } from "shared/IpcEvents";

import { onIpcCommand } from "./ipcCommands";

const logger = new Logger("VxmpireRPC", "#5865f2");
