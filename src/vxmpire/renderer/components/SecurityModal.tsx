...
import { Button, Flex, Heading, Paragraph } from "@Vxmpire/types/components";
import { ModalContent, ModalFooter, ModalHeader, ModalRoot } from "@Vxmpire/types/utils";
import { React } from "@Vxmpire/types/webpack/common";
            ...
            <ModalContent style={{ padding: "16px 24px" }}>
                <div style={{
                    ...
                    <Paragraph style={{ fontWeight: "bold", marginBottom: "6px", color: "var(--text-normal)" }}>
                        VxmpireFr is a 100% Free product.
                    </Paragraph>
                    ...
                    <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                        ...
                        <li style={{ color: "var(--text-normal)" }}>
                            ...
                            <span
                                ...
                                onClick={() => VencordNative.native.openExternal("https://discord.gg/vxmpire")}
                            >
                                discord.gg/vxmpire
                            </span>
                        </li>
                ...
                <div style={{
                    ...
                    <Paragraph style={{ color: "var(--text-muted)", fontStyle: "italic", fontSize: "13px" }}>
                        <strong>Note:</strong> Only download VxmpireFr via our official channels to ensure your security.
                    </Paragraph>
                </div>
            </ModalContent>
