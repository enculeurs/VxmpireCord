...
import { useState } from "@Vxmpire/types/webpack/common";
    ...
    return (
        <>
            <VesktopSettingsSwitch
                ...
                description="Automatically start Vxmpire on computer start-up"
            ...
            <VesktopSettingsSwitch
                ...
                description={"Start Vxmpire minimized when starting with system"}
