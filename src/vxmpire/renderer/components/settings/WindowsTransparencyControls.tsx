...
import { Heading, Paragraph } from "@Vxmpire/types/components";
import { Margins } from "@Vxmpire/types/utils";
import { Select } from "@Vxmpire/types/webpack/common";
            ...
            <SimpleErrorBoundary>
                <Select
                    ...
                    options={[
                        ...
                        {
                            label: "Acrylic (blurs the window behind Vxmpire for a translucent background)",
                            value: "acrylic"
                        }
                    ]}
                    closeOnSelect={true}
