...
import { BaseText, Button, FormSwitch } from "@Vxmpire/types/components";
import {
    Margins,
    ModalCloseButton,
    ModalContent,
...
import { showToast, useState } from "@Vxmpire/types/webpack/common";
        ...
        <section>
            ...
            <div className="vcd-user-assets-asset">
                <img
                    ...
                    src={`vxmpire://assets/${asset}?v=${version}`}
                    alt=""
