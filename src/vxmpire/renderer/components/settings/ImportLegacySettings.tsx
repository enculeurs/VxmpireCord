...
import { BaseText } from "@Vxmpire/types/components";
import { React, useRef,useState } from "react";

import { cl } from "./Settings";

function detectSource(json: any): "equicord" | "vencord" | "vxmpire" | "unknown" {
    ...
    // Plugins spécifiques à Vxmpire
    if (pluginNames.some(p => ["VxmpireHelper", "equicordHelper"].includes(p))) return "vxmpire";
...
function cleanForVxmpire(json: any): any {
    ...
    // Supprimer les plugins propres à Equicord/Vencord qui n'existent pas dans Vxmpire
    ...
    async function processFile(file: File) {
        ...
        try {
            ...
            const sourceLabel =
                ...
                source === "vxmpire" ? "Vxmpire" : "inconnu";

            const cleaned = cleanForVxmpire(json);
            ...
            setStatus("success");
            setMessage(`✅ Settings ${sourceLabel} importés avec succès ! Redémarre Vxmpire pour appliquer.`);
        } catch (err: any) {
            setStatus("error");
    ...
    return (
        <div className={cl("category")}>
            ...
            <BaseText size="sm" style={{ marginBottom: "12px", opacity: 0.7 }}>
                Drag & drop your Equicord or Vencord backup JSON file here to import your settings into Vxmpire.
                Plugin-specific settings that don't exist in Vxmpire will be automatically removed.
            </BaseText>
