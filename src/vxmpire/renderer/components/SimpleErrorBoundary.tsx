...
import { Card, ErrorBoundary, HeadingTertiary, Paragraph, TextButton } from "@Vxmpire/types/components";
import { FluxDispatcher, InviteActions } from "@Vxmpire/types/webpack/common";
...
function Fallback() {
    return (
        <Card variant="danger">
            ...
            <Paragraph>
                Please make sure Vxmpire and Vxmpire are fully up to date. You can get help in our{" "}
