...
import { onceReady } from "@Vxmpire/types/webpack";
import { FluxDispatcher, MediaEngineStore, Select, UserStore, useState } from "@Vxmpire/types/webpack/common";
...
const logger = new Logger("VxmpireScreenShare");
