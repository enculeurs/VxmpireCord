    ...
    return (
        <SettingsTab>
            ...
            <Notice.Info className={Margins.bottom16} style={{ width: "100%" }}>
                {t("Looking for themes? Check out")} <Link href="https://vxmpire.st/themes">{t("Vxmpire Themes")}</Link> {t("or search on")} <Link href="https://github.com/search?q=discord+theme">GitHub</Link>. {t("When downloading from BetterDiscord, click \"Download\" and place the .theme.css file into your themes folder.")}
            </Notice.Info>
