...
const STORAGE_KEY = "vxmpire_mellowtel_onboarding_seen_v" + MELLOWTEL_ONBOARDING_VERSION;
        ...
        <>
            ...
            <ModalContent style={{ padding: "16px 20px" }}>
                <Paragraph style={{ color: "#dbdee1", fontSize: "14px", lineHeight: "1.5" }}>
                    {t(
                        "Vxmpire is free and will stay that way. You can optionally help fund development " +
                        ...
                        "and Vxmpire gets a share of the revenue. Mellowtel never reads your personal data, " +
                ...
                <Paragraph style={{ marginTop: "12px", color: "#949ba4", fontSize: "13px" }}>
                    {t("You can change this choice at any time from Vxmpire's settings.")}
                </Paragraph>
                    ...
                    <div style={{ marginTop: "20px", borderTop: "1px solid rgba(255, 255, 255, 0.08)", paddingTop: "16px" }}>
                        ...
                        >
                            <div style={{ paddingRight: "8px", fontSize: "11px", color: "#949ba4", lineHeight: "1.5" }}>
                                ...
                                <p style={{ marginBottom: "12px" }}>By selecting decline you are acknowledging that you are opting out of supporting the network interface architecture. Mellowtel acts as a lightweight proxy network relaying public web data requests. As an infrastructure partner, Vxmpire depends on this monetization model to continue hosting APIs, gateways, and maintaining fast file distribution networks completely free of charge.</p>
