 ...
 * video in https://source.vxmpire.st/vxmpire/vxmpire-tutorials/src/branch/main/videos
 *
...
/**
 * Set of plugin names that have a tutorial video available in vxmpire-tutorials.
