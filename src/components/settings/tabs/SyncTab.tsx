...
const cloudBackendOptions = [
    { label: "Vxmpire Cloud", value: "https://api.vxmpire.st/" },
...
const BADGE_OPTIONS: Array<{ label: string; value: BadgeSource }> = [
    { label: "Vxmpire Badges", value: "vxmpire" },
...
function renderPrefix(option: { value: BadgeSource }) {
    switch (option.value) {
        case "vxmpire": return <VxmpireIcon />;
    ...
    return (
        <div style={{ marginBottom: 16 }}>
            <FormSwitch
                ...
                title={t("Vxmpire Sync")}
                description={isEnabled
                    ? t("Your custom profile is synced. Other Vxmpire users can see your profile, and you can see theirs.")
                    : t("Enable to share your custom profile with other Vxmpire users and see their profiles.")}
                disabled={busy}
            />
    ...
    return (
        <>
            ...
            <Paragraph className={Margins.bottom16}>
                {t("Vxmpire's cloud integration allows you to sync your settings across multiple devices and Discord installations. Your data is securely stored and can be easily restored at any time.")}
            </Paragraph>

            <Notice.Info className={Margins.bottom16}>
                {t("We use our own Vxmpire Cloud backend with enhanced features.")}
                {" "}
            ...
            <div className={Margins.bottom8}>
                <SearchableSelect
                    ...
                    renderOptionPrefix={o => {
                        if (o?.value?.includes("vxmpire")) return <VxmpireIcon />;
            ...
            <Paragraph className={Margins.bottom16}>
                {t("Synchronize your Vxmpire settings to the cloud. This makes it easy to keep your configuration consistent across multiple devices without manual import/export.")}
            </Paragraph>
