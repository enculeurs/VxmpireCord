        ...
        <SettingsTab>
            ...
            <div className={Margins.bottom8}>
                <SearchableSelect
                    ...
                    closeOnSelect={true}
                    renderOptionPrefix={o => o?.value?.includes("vxmpire") ? <VxmpireIcon /> : o?.value?.includes("equicord") ? <EquicordIcon /> : <VencordIcon />}
                />
            </div>
