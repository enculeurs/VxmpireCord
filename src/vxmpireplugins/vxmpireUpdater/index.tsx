...
// Config
const REMOTE_VERSION_URL = `https://source.${domain}/api/v1/repos/vxmpire/vxmpire/releases/latest`;
...
async function checkForUpdates() {
    try {
        ...
        console.error("[VxmpireUpdater] Error:", e);
    }
}
...
function UpdateBanner() {
    ...
    async function doUpdate() {
        ...
        try {
            ...
            setTimeout(() => {
                try {
                    VencordNative.vxmpire?.relaunch?.();
                } catch {
            ...
            console.error("[VxmpireUpdater] Update error:", e);
    ...
    return React.createElement("div", {
        ...
        React.createElement("div", {
            ...
            React.createElement("span", { style: { fontWeight: 700, flexShrink: 0 } },
                `Vxmpire ${info.remoteVersion} available!`
            ),
...
function mountBanner() {
    if (bannerContainer || document.getElementById("vxmpire-updater-root")) return;

    waitFor(["createRoot", "render"], (ReactDOM: any) => {
        if (bannerContainer || document.getElementById("vxmpire-updater-root")) return;
        bannerContainer = document.createElement("div");
        bannerContainer.id = "vxmpire-updater-root";
        ...
        try {
            ...
            console.error("[VxmpireUpdater] Error mounting banner:", e);
...
export default definePlugin({
    ...
    description: "Shows a banner when a new Vxmpire version is available. Click Update to install.",
