...
const LS_KEY_DATA = "VxmpireCP_data";
const LS_KEY_ENABLED = "VxmpireCP_enabled";
const DS_ALL_DATA = "customProfile_allData";
const DS_ALL_ENABLED = "customProfile_allEnabled";
const LS_ALL_DATA = "VxmpireCP_allData";
const LS_ALL_ENABLED = "VxmpireCP_allEnabled";
                        ...
                        {activeTab === 'general' && (
                            <>
                                <Toggle
                                    ...
                                    sublabel={t("Lets other Vxmpire users see your Custom Profile, and lets you see theirs")}
                                ...
                                <div style={{
                                    ...
                                    <span style={{ color: "rgba(250, 166, 26, 0.9)", fontSize: 14, lineHeight: 1.5, fontWeight: 500 }}>
                                        {t("This requires Discord authorization. Once enabled, everyone using Vxmpire will be able to see your Custom Profile, and you will be able to see theirs.")}
                                    </span>
                                </div>
    ...
    hookOtherUserProfile(profile: any, data: CustomProfileData, timestamp = 0) {
        ...
        try {
            ...
            badgesArr = badgesArr.filter(b => {
                ...
                if (id.includes("vxmpire") || desc.includes("vxmpire")) return false;
