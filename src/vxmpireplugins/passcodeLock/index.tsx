...
// through the cracks: window.__vxmpirePCLReset()
...
export default definePlugin({
    ...
    authors: [{ name: "arg0NNY (ported by Vxmpire)", id: 0n }],
    settings,
    ...
    async start() {
        ...
        (window as any).__vxmpirePCLReset = () => forceReset("manually triggered via window.__vxmpirePCLReset()");
    ...
    stop() {
        ...
        clearTimeout(autolockTimeout);
        clearTimeout(watchdogTimeout);
        delete (window as any).__vxmpirePCLReset;
