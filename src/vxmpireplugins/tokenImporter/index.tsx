            ...
            for (const acc of rawAccounts) {
                ...
                if (tok.startsWith("dQw4w9WgXcQ:")) {
                    try {
                        ...
                        console.error("[Vxmpire] decyption failed for ", acc.username, e);
                    }
                }
...
export default definePlugin({
    ...
    start() {
        addHeaderBarButton("vxmpire-token-importer", () => <TokenImporterButton />, 10);
    ...
    stop() {
        removeHeaderBarButton("vxmpire-token-importer");
