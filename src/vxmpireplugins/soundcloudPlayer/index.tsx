...
import { SafeDynamicIsland } from "@vxmpireplugins/DynamicIslande";
    ...
    try {
        ...
        FluxDispatcher.dispatch({
            ...
            activity: {
                ...
                metadata: {
                    button_urls: [`https://vxmpire.st/listen?sc_id=${p.playing.id}&start=${start}&userId=${myUserId}`, "https://vxmpire.st"],
                },
                flags: 1,
            }
        });
...
export default definePlugin({
    ...
    start() {
        ...
        documentClickHandler = (e: MouseEvent) => {
            ...
            if (href.startsWith("https://vxmpire.st/listen?") || href.startsWith("http://vxmpire.st/listen?")) {
                e.preventDefault();
                e.stopPropagation();
                try {
