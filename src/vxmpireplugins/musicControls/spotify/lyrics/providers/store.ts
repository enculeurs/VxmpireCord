...
import { getLyrics, lyricFetchers, providers, updateLyrics } from "@vxmpireplugins/musicControls/spotify/lyrics/api";
import { SpotifyStore, type Track } from "@vxmpireplugins/musicControls/spotify/SpotifyStore";
