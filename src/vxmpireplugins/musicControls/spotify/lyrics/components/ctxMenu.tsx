...
import { providers } from "@vxmpireplugins/musicControls/spotify/lyrics/api";
import { lyricsAlternative } from "@vxmpireplugins/musicControls/spotify/lyrics/providers/store";
