    ...
    return (
        <div className={cl("page")}>
            ...
            <div className={cl("guide-section")}>
                ...
                <BaseText size="sm" color="text-muted">
                    {t("The numbers are samples collected while you use Vxmpire. If a plugin is not used during collection, it may look light even if it does more work in other situations.")}
                </BaseText>
            </div>
