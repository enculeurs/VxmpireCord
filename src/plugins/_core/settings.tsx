...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the Vxmpire settings section",
        options: [
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        const fullEntries: SettingsLayoutNode[] = [
            ...
            buildEntry({
                ...
                panelTitle: "Vxmpire Sync",
                Component: SyncTab,
                Icon: CloudIcon
            }),
            buildEntry({
                key: "vxmpire_language",
                title: "Language",
        ...
        const equicordSection: SettingsLayoutNode = {
            ...
            useTitle: () => {
                try { if (localStorage.getItem("Vxmpire_stealthMode") === "1") return ""; } catch { }
                return t("Vxmpire Settings");
            },
            buildLayout: () => {
                try { if (localStorage.getItem("Vxmpire_stealthMode") === "1") return [mainEntry]; } catch { }
                return fullEntries;
            }
        };
    ...
    getInfoRows() {
        ...
        const rows = [`Vxmpire ${gitHashShort}${getVersionInfo()}`];
