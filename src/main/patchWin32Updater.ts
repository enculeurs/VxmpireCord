...
// Vxmpire was installed (dev-inject asar, the PS1/Inno installer, or
...
function patchLatest() {
    try {
        ...
        console.info("[Vxmpire] Detected Host Update. Repatching...");
        ...
        const indexJs = [
            ...
            "} catch (e) {",
            "    console.error(\"[Vxmpire] Repatch injection failed, falling back to vanilla Discord:\", e);",
        ...
        console.error("[Vxmpire] Failed to repatch latest host update", err);
    }
}
