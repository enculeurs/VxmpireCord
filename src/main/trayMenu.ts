...
function createVxmpireMenuItems(): MenuItemConstructorOptions[] {
    return [
        {
            label: "Vxmpire",
            submenu: [
                ...
                {
                    label: cachedUpdateAvailable ? "Update Vxmpire" : "Check for Updates",
...
export function patchTrayMenu(): void {
    // No longer patching tray menu — Vxmpire manages its own tray in patcher.ts
}
