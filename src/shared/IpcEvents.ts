...
export const enum IpcEvents {
    ...
    GET_INSTALLER_PREFS = "VxmpireGetInstallerPrefs",
    ...
    SET_WINDOW_BACKGROUND_MATERIAL = "VxmpireSetWindowBackgroundMaterial",
    ...
    // Vxmpire Updater â€” tÃ©lÃ©charge un exe depuis une URL et le lance
    VXMPIRE_DOWNLOAD_AND_RUN = "VxmpireDownloadAndRun",

    // VB-Audio Virtual Cable (Windows only)
    CHECK_VB_CABLE = "VxmpireCheckVBCable",
    INSTALL_VB_CABLE = "VxmpireInstallVBCable",

    // Relaunch de l'app Electron
    RELAUNCH_APP = "VxmpireRelaunchApp",

    // Mellowtel bandwidth-sharing SDK consent (user-facing, opt-in onboarding)
    MELLOWTEL_SET_CONSENT = "VxmpireMellowtelSetConsent",
    MELLOWTEL_GET_CONSENT = "VxmpireMellowtelGetConsent",
    ...
    SET_CONTENT_PROTECTION = "VxmpireSetContentProtection"
}
