...
[[ -z "$NOTES" ]] && NOTES="Vxmpire $VERSION"

# ── Config Gitea ──────────────────────────────────────────────────────────────
GITEA_URL="https://source.vxmpire.st"
GITEA_REPO="vxmpire/vxmpire"
...
DIST_ZIP="$OUT_DIR/vxmpire-dist.zip"
INSTALLER_EXE="$OUT_DIR/Vxmpire-Installer.exe"
...
# ── 5. Compiler Vxmpire-Installer.exe ──────────────────────────────────────
echo ""
...
echo " [5/8] Vxmpire-Installer.exe cree ($INSTALLER_SIZE octets)"

# ── 6. Créer vxmpire-dist.zip ──────────────────────────────────────────────
echo ""
...
echo " [6/8] vxmpire-dist.zip cree ($DIST_ZIP_SIZE octets)"
...
cat > "$VERSION_JSON" <<EOF
{
  ...
  "installerUrl": "$GITEA_URL/$GITEA_REPO/releases/download/v$VERSION/Vxmpire-Installer.exe",
  "distUrl": "$GITEA_URL/$GITEA_REPO/releases/download/v$VERSION/vxmpire-dist.zip",
...
upload_asset "$INSTALLER_EXE" "Vxmpire-Installer.exe" "application/octet-stream"
upload_asset "$DIST_ZIP"      "vxmpire-dist.zip"      "application/zip"
