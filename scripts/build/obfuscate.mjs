// @ts-check
/*
 * Vxmpire — Post-build obfuscation
...
// ─── Target files ───────────────────────────────────────────────────────────
// dist/js/   → buildDesktop (Vxmpire app itself)
...
// dist/desktop/ and dist/vxmpire/ → build.mjs (vencord asar)
const ASAR_JS_FILES = [
    "patcher.js",
    "preload.js",
    "renderer.js",
 ...
 * @param {string} dir  e.g. "dist/desktop" or "dist/vxmpire"
 */
