/*
 * Vxmpire, a desktop app aiming to give you a snappier Discord Experience
...
await Promise.all([
    ...
    createContext({
        ...NodeCommonOpts,
        entryPoints: ["src/vxmpire/main/index.ts"],
    ...
    createContext({
        ...NodeCommonOpts,
        entryPoints: ["src/vxmpire/preload/index.ts"],
        outfile: "dist/js/preload.js",
        footer: { js: "//# sourceURL=VesktopPreload" }
    }),
    createContext({
        ...NodeCommonOpts,
        entryPoints: ["src/vxmpire/preload/splash.ts"],
        outfile: "dist/js/splashPreload.js",
        footer: { js: "//# sourceURL=VesktopSplashPreload" }
    }),
    createContext({
        ...NodeCommonOpts,
        entryPoints: ["src/vxmpire/preload/updater.ts"],
    ...
    createContext({
        ...CommonOpts,
        globalName: "Equibop",
        entryPoints: ["src/vxmpire/renderer/index.ts"],
        outfile: "dist/js/renderer.js",
        format: "iife",
        inject: ["./scripts/build/injectReact.mjs"],
        jsxFactory: "VencordCreateElement",
        jsxFragment: "VencordFragment",
        external: ["@Vxmpire/types/*", "@vxmpire/types/*"],
        plugins: [vencordDep, includeDirPlugin("patches", "src/vxmpire/renderer/patches")],
