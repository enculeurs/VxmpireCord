<script>
    ...
    onMount(async () => {
        ...
        const options = {
            hostname: "source.vxmpire.st",
            path: "/api/v1/repos/vxmpire/vxmpire/releases/latest",
            method: "GET",
            rejectUnauthorized: false,
            headers: {"User-Agent": "vxmpire-installer"}
        };
...
<header class="titlebar {macButtons === true ? "type-mac" : "type-standard"}">
    <span class="title">Vxmpire Installer v{displayVersion}</span>
