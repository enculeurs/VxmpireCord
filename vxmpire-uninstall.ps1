# ==============================================================================
#  Vxmpire — Désinstalleur utilisateur (PowerShell)
#  Supprime l'injection Vxmpire de Discord
#
...
$InstallDir    = Join-Path $env:LOCALAPPDATA "Vxmpire-Client"
...
Write-Host "  ║      VXMPIRE — Désinstalleur           ║" -ForegroundColor Cyan
Write-Host "  ╚══════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  │  Vxmpire désinstallé avec succès !                 │" -ForegroundColor Green
